...
namespace GitLab.NET.Repositories
{
    ...
    public class EmailRepository : RepositoryBase
    {
        ...
        public async Task<RequestResult<EmailAddress>> Create(string email, uint? userId = null)
        {
            if (email == null)
        ...
        /// <param name="userId"> The user's ID. </param>
        /// <returns> A <see cref="RequestResult{EmailAddress}" /> representing the results of the request. </returns>
        public async Task<RequestResult<EmailAddress>> Delete(uint id, uint? userId = null)
        {
        ...
        /// <returns> A <see cref="RequestResult{EmailAddress}" /> representing the results of the request. </returns>
        public async Task<RequestResult<EmailAddress>> Find(uint id)
        {
        ...
        ///     the request.
        /// </returns>
        public async Task<RequestResult<List<EmailAddress>>> GetForUser(uint? userId = null)
        {
            var resource = userId != null ? "users/{userId}/emails" : "user/emails";
